...
//        File file=new File(DataBaseHelper.DBLOCATION+DataBaseHelper.DBNAME);
//        if (file.exists()){
//            Toast.makeText(this,"Exists",Toast.LENGTH_SHORT).show();
//        }else{
//            Toast.makeText(this,DataBaseHelper.DBLOCATION+DataBaseHelper.DBNAME,Toast.LENGTH_SHORT).show();
//        }
    }
}
